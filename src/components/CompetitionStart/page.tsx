  ...
  return (
    <div className="p-1 w-full border border-gray-200 rounded-lg max-w-screen-lg flex justify-between my-2">
      <div className="flex gap-x-10">
        <div className="text-6xl text-[var(--gray-300)]  my-auto">
          {/* {props.id} */}
        </div>
        <div>
          <p className="text-sm font-medium text-[var(--brand-800)] ">
            Tiêu đề cuộc thi
          </p>
          <p className="text-[var(--black-80)]  flex items-center gap-x-1">
            <Calendar />
            15/11/2023 - 16/11/2023
          </p>
        </div>
      </div>
      {COMPETITION_STATUS.HAPPENNING === competition.status ? (
        <div className="flex items-center gap-x-2 ">
          <button
            type="button"
            className="btn-processing btn-icon text-base hover:cursor-default"
          >
        ...
        <div className="flex items-center  gap-x-2">
          <button
            type="button"
            className="!text-[var(--error-600)] btn btn-icon text-base  !bg-[var(--error-100)] hover:cursor-default"
          >
