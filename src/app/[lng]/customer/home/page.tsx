...
const HomePage = () => {
  return (
    <div className="h-full gap-8 p-8 w-full  rounded-lg max-w-screen-lg m-auto flex flex-col shadow-sm">
      <div className="flex gap-4">
        <div className="flex flex-1 flex-col rounded-lg  overflow-hidden  items-center shadow-md bg-gray-100">
